...
# ignored (verified empirically). What raw `git stash` does under the guard
# is not asserted anywhere that ships — it is measured, in
# scripts/wt_stash_test.go:  go test ./scripts/ -run TestStashGuard -v
set -euo pipefail
